  ...
  return (
   <>
      <div className='relative h-28 w-32 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14'>
        ...
        />
        <div className='absolute top-11 left-11 lg:top-10 lg:left-9 sm:top-4 sm:left-5 right-0 opacity-100 z-[100] w-8 h-8 md:w-5 md:h-5 flex items-center justify-center rounded-full'>
            <PlayIcon className='icon-style md:w-3 md:h-3 text-white-1100' />
        </div>
        <video
            autoPlay={true}
            loop={true}
